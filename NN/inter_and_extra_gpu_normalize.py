...
for target in tqdm(target_column, desc="Processing Targets"):
    ...
    for fold, (train_idx, val_idx) in enumerate(tqdm(kf.split(X_train_full), desc="Folds", leave=False)):
        ...
        # ★ここで各foldのトレーニングデータから標準化パラメータを計算し、
        #    検証データとテストデータに適用する
...
results_df.to_csv('/home/mdxuser/sasaki/results_combined_norm.csv', index=False)
print("Results saved to /home/mdxuser/sasaki/results_combined_norm.csv")